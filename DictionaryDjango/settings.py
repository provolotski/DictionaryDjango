...
SECRET_KEY = 'django-insecure-i&av-z7i6n-r9ol8bop%txb&flezw#8+uwb%v%)ul3!av6zy7w'
...
ROOT_URLCONF = 'DictionaryDjango.urls'
...
WSGI_APPLICATION = 'DictionaryDjango.wsgi.application'
